 ...
 */
class ModuleMissionsList extends \Module
{
     ...
     * @var string
     */
    protected $strTemplate = 'mod_missions_list';
    ...
    protected function compile()
    {
        ...
        if (!\Input::get('year')) { $showYear = date("Y"); }
        if (\Input::get('year'))  { $showYear = \Input::get('year'); }
		
		$objMissions = $this->Database->execute("SELECT * FROM tl_missions WHERE year = ".$showYear." ORDER BY lfdnr DESC");
